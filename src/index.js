...
export default class App extends Component {
  constructor (props) {
    ...
    // try {
    //   initialValues = JSON.parse(window.localStorage.stateDefault);
    // } catch (e) {}
  ...
  //     case 68:
  //       delete window.localStorage.stateDefault;
  ...
  //         window.localStorage.stateDefault = JSON.stringify(this.state);
  //       //}
  //       break;
  //   }
  // }
